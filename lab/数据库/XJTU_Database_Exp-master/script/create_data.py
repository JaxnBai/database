...
first_name = ["赵", "钱", "孙", "李", "刘","周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤", "许", "何",
              "吕", "施", "张", "孔", "曹", "严", "华","石", "金", "魏", "陶", "姜", "戚", "谢", "邹", "喻", "柏", "水", "窦", "章", "云", "苏",
              "潘", "葛", "奚", "范", "彭", "郎", "鲁", "韦", "昌", "马", "苗", "凤", "花", "方", "俞", "任", "袁", "柳", "酆", "鲍", "史",
              "唐", "费", "廉", "岑", "薛", "雷", "贺", "倪", "汤", "滕", "殷", "罗", "毕", "郝", "邬", "安", "常", "乐", "于", "时", "傅",
              "皮", "卞","徐", "齐", "康", "伍", "余", "元", "卜", "顾", "孟", "平", "黄", "和", "穆", "萧", "尹", "姚", "邵", "堪", "汪"]
last_name = ['玉', '明', '龙', '芳', '军', '玲', '', '立', '玲', '', '国', "地", "为", "子", "中", "", "", "", "国", "年", "着", "就",
             "那", "和", "要", "刚","她", "出", "也", "", "", "", "自", "以", "会", "家", "可", "下", "事", "把", "还", "用", "第", "样", "道",
             "想", "作", "种", "开", "美", "总", "从", "无", "情", "己", "面", "最", "女", "但", "现", "前", "些", "所", "同", "日", "手",
             "又", "行", "丽","意", "动", "方", "期", "它", "头", "经", "长", "儿", "回", "位", "分", "爱", "老", "因", "很", "给", "名", "法",
             "间", "斯", "知","雪", "世", "什", "两", "次", "使", "身", "者", "被", "高", "已", "亲", "其", "进", "此", "话", "常", "与", "活",
             "正", "感", "见", "明","建", "问", "力", "理", "尔", "点", "文", "几", "定", "本", "公", "特", "做", "外", "孩", "相", "西", "果",
...
first_class = ['深度', '爱情', '经济', '电机', '电路', '数据结构','物理','数学分析','医学','睡眠', '操作', '数据库', '网络', '计算机组成']
last_class = ['学习', '理论','课程','导论', '教学', '实践','项目', '基础']
deps = ['CS', 'EE','HT','MI','ML', 'SC', 'FI','PH','ST','HH', 'LLM','CV','BA','AI', 'HW']
...
for i in range(C_LEN):
    ...
    class_name = random.choice(first_class)  + random.choice(last_class)
    full_name = gen_name()
